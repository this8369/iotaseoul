    ...
    return (
        <section className="section w-full h-auto bg-white pt-12 pb-[100px]" id="section-airquality">
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto border-t-[1px] border-black pt-12 bs-fade-up">
                ...
                {/* Top Video Area */}
                <div className="relative w-full h-[50vh] md:h-[60vh] lg:h-[75vh] overflow-hidden mb-12 flex items-start p-6 md:p-12">
                    <video
                ...
                <div className="w-full flex flex-col">
                    ...
                    <div className="w-full flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16">
                        ...
                        <div className="w-full lg:w-[55%] flex flex-col">
                            ...
                            <h4 className="text-[14px] md:text-[16px] lg:text-[18px] font-bold text-gray-700 tracking-[-0.01em] mb-8 font-inter"
                                data-en="Achieving Continuous Clean Air and Optimal Comfort through Real-Time Sensing"
                            ...
                            {/* KR Text */}
                            <div className="text-[13px] md:text-[14px] lg:text-[15px] font-medium text-black leading-[1.7] tracking-[-0.02em] break-keep kr-target-text en-only-hide mb-6">
                                <p className="mb-2">
                            ...
                            {/* EN Text */}
                            <div className="text-[12px] md:text-[13px] lg:text-[14px] font-normal text-gray-800 leading-[1.7] tracking-[-0.01em] font-inter">
                                <p className="mb-2">
                        ...
                        {/* Right Column: Grid */}
                        <div className="w-full lg:w-[45%] flex flex-col font-inter">

                            {/* Grid Title */}
                            <div className="w-full flex flex-col md:flex-row md:items-baseline gap-2 mb-4">
                                <h5 className="font-bold text-[14px] md:text-[16px] text-black tracking-tight leading-none">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-[1px] bg-gray-200">
                                ...
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">PM2.5</span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 15 μg/m³</span>
                                </div>
                                {/* PM10 */}
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">PM10</span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 30 μg/m³</span>
                                </div>
                                {/* TVOC */}
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">TVOC</span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 300 μg/m³</span>
                                </div>
                                {/* CO */}
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">CO</span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 6 ppm</span>
                                </div>
                                {/* O3 */}
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">O<sub className="text-[10px]">3</sub></span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 80 μg/m³</span>
                                </div>
                                {/* NO2 */}
                                <div className="bg-[#f0f5fa] flex flex-col items-center justify-center py-6 px-4">
                                    <span className="text-[12px] text-gray-600 mb-1 font-medium">NO<sub className="text-[10px]">2</sub></span>
                                    <span className="text-[18px] md:text-[22px] font-bold text-black tracking-tight leading-none">≤ 30 μg/m³</span>
                                </div>
                            </div>
