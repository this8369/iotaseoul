                ...
                <div className="w-full flex flex-col items-center text-center mb-12 bs-fade-up">
                    ...
                    <div className="text-[16px] md:text-[17px] lg:text-[18px] font-medium text-black leading-[1.7] md:leading-[1.8] space-y-4 tracking-[-0.02em] max-w-[1200px]">
                        <p className="kr-target-text transition-all duration-300"
                            ...
                            data-en="IOTA Seoul is the only trophy-grade mixed-use development directly connected to Namsan Park,<br className='hidden md:block' />Seoul's largest urban green space spanning 710 AC.<br/>Located in the city's urban core near Seoul Station, it uniquely combines metropolitan accessibility with<br className='hidden md:block' />immersive natural surroundings rarely found in major capital cities.<br/>This proximity to nature offers exceptional value to global companies seeking wellness-focused,<br className='hidden md:block' />productivity-enhancing work environments, positioning IOTA as a true &quot;Green Retreat in the City&quot; with<br className='hidden md:block' />unmatched differentiation.">
                            IOTA Seoul is the only trophy-grade mixed-use development directly connected to Namsan Park, <br className="hidden md:block" />
                            Seoul's largest urban green space spanning 710 AC.<br />
                            Located in the city's urban core near Seoul Station, it uniquely combines metropolitan accessibility with <br className="hidden md:block" />
                            immersive natural surroundings rarely found in major capital cities.<br />
                            ...
                            productivity-enhancing work environments, positioning IOTA as a true "Green Retreat in the City" with <br className="hidden md:block" />
